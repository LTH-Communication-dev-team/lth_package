 ...
 */
class LthpackageDatabaseRecordList extends DatabaseRecordList
{
    /**
    ...
    public function listURL($alternativeId = '', $table = '-1', $excludeList = '')
    {
        ...
        $demand = GeneralUtility::_GET('tx_lthpackage_web_convertdce');
        if (is_array($demand['demand'])) {
            $urlParameters['tx_lthpackage_web_convertdce']['demand'] = $demand['demand'];
        }

        return BackendUtility::getModuleUrl('web_lthpackage_convertdce', $urlParameters);
    }
}
