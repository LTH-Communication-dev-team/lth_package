...
.hideItem {
    display:none;
        ...
        $content .= '<textarea rows="10" cols="50" id="lthpackageGridDisplay" 
     name="'.$PA['itemFormElName'].'"
     onchange="'.htmlspecialchars(implode('',$PA['fieldChangeFunc'])).'"
     '.$PA['onFocus'].'
     >'.htmlspecialchars(($PA['itemFormElValue'] ? $PA['itemFormElValue']:'Default value')).'</textarea>';
...
<div class="modal fade" id="gridelementsModal" tabindex="-1" role="dialog" aria-labelledby="gridelementsModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <textarea id="lthPackageGridContent" style="width:200px;height:100px;"></textarea>
      <input type="text" id="lthPackageGridId" />
      </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            editItem: function(item) {
                ...
                TYPO3.jQuery("#lthPackageGridContent").val(gridContent);
...
TYPO3.jQuery(document).ready(function() {
    ...
    TYPO3.jQuery("#gridelementsModal .btn-primary").click(function(){
        ...
        var gridContent = TYPO3.jQuery("#lthPackageGridContent").val();
