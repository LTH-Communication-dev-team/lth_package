 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['calendar'])) {
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:lth_package/Resources/Private/Language/backend.xlf:content_element.calendar',
        'calendar',
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['calendar'] = 'content-lthpackage-calendar';

/***************
 * Configure element type
 */
$GLOBALS['TCA']['tt_content']['types']['calendar'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['calendar'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Calendar.xml',
    'calendar'
);