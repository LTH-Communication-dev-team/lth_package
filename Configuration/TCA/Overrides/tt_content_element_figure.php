 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['figure'])) {
    $GLOBALS['TCA']['tt_content']['types']['figure'] = [];
}
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:lth_package/Resources/Private/Language/Backend.xlf:content_element.figure',
        'figure',
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['figure'] = 'content-lthpackage-figure';

$GLOBALS['TCA']['tt_content']['types']['figure'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['figure'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Figure.xml',
    'figure'
);