 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['navigation'])) {
    $GLOBALS['TCA']['tt_content']['types']['navigation'] = [];
}
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['navigation'] = 'content-lthpackage-navigation';

$GLOBALS['TCA']['tt_content']['types']['navigation'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['navigation'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Navigation.xml',
    'navigation'
);