 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['infobox'])) {
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['infobox'] = 'content-lthpackage-infobox';

/***************
 * Configure element type
 */
$GLOBALS['TCA']['tt_content']['types']['infobox'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['infobox'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Infobox.xml',
    'infobox'
);