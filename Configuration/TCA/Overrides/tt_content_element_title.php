<?php
     ...
     * Add Content Element
     */
    if (!is_array($GLOBALS['TCA']['tt_content']['types']['title'])) {
        $GLOBALS['TCA']['tt_content']['types']['title'] = [];
    }
     ...
     * Assign Icon
     */
    $GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['title'] = 'content-lthpackage-title';

    $GLOBALS['TCA']['tt_content']['types']['title'] = array_replace_recursive(
        $GLOBALS['TCA']['tt_content']['types']['title'],
        [
            'showitem' => '
    ...
    */
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
        '*',
        'FILE:EXT:lth_package/Configuration/FlexForms/Title.xml',
        'title'
    );