 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['toggle'])) {
    $GLOBALS['TCA']['tt_content']['types']['toggle'] = [];
}
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:lth_package/Resources/Private/Language/backend.xlf:content_element.toggle',
        'toggle',
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['toggle'] = 'content-lthpackage-toggle';

$GLOBALS['TCA']['tt_content']['types']['toggle'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['toggle'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Toggle.xml',
    'toggle'
);