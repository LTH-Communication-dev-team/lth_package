 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['infographics'])) {
    $GLOBALS['TCA']['tt_content']['types']['infographics'] = [];
}
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:lth_package/Resources/Private/Language/Backend.xlf:content_element.infographics',
        'infographics',
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['infographics'] = 'content-lthpackage-infographics';

$GLOBALS['TCA']['tt_content']['types']['infographics'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['infographics'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Infographics.xml',
    'infographics'
);