 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['progress'])) {
    $GLOBALS['TCA']['tt_content']['types']['progress'] = [];
}
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['progress'] = 'content-lthpackage-progress';

$GLOBALS['TCA']['tt_content']['types']['progress'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['progress'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Progress.xml',
    'progress'
);