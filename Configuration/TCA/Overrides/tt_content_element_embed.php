 ...
 * Add Content Element
 */
if (!is_array($GLOBALS['TCA']['tt_content']['types']['embed'])) {
    $GLOBALS['TCA']['tt_content']['types']['embed'] = [];
}
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'CType',
    [
        'LLL:EXT:lth_package/Resources/Private/Language/backend.xlf:content_element.embed',
        'embed',
 ...
 * Assign Icon
 */
$GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['embed'] = 'content-lthpackage-embed';

/***************
 * Configure element type
 */
$GLOBALS['TCA']['tt_content']['types']['embed'] = array_replace_recursive(
    $GLOBALS['TCA']['tt_content']['types']['embed'],
    [
        'showitem' => '
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    '*',
    'FILE:EXT:lth_package/Configuration/FlexForms/Embed.xml',
    'embed'
);